    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['jxgl:teaching:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
...
<script>
import { listTeaching, getTeaching, delTeaching, addTeaching, updateTeaching } from "@/api/jxgl/teaching";
import { listAllCourse } from "@/api/jxgl/course";
import { listAllTeacher } from "@/api/jxgl/teacher";
